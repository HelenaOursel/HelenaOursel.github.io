  ...
  return (
    <div className="presentation">
      ...
      <div className="profile-description">
        <h1>Héléna Oursel</h1>
        <p>
          Bonjour, je suis une développeuse passionnée avec une expertise en Front-End et JavaScript.
        ...
        <p>
          ...
          Je crois en l'apprentissage continu et je suis toujours ouverte à de nouvelles technologies et méthodologies.
        </p>
      </div>
    </div>
  );
